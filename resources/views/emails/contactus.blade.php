		...
		<tbody>
			...
			<tr>
				<td colspan="2" style="padding: 20px;" align="center" >
					...
					<span style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Following Details has been submitted from {{ $userData['firstname'] . " " . $userData['lastname'] }} Contact us Form.</span>
				</td>
			</tr>
			<tr>

...
<head>
	...
	<title>Booking Confirmation on {{ config('legacy.site_name') }}</title>
	<style type="text/css">
		body{
		margin: 0;
		padding: 0;
		...
		<tbody>
			...
			<tr>
				<td colspan="2" style="padding: 20px;" align="center" >
					...
					<span style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Thank you for placing your order. A member of our staff will reach out to you directly with any questions. For immediate assistance please call 858-858-8588.<br/>Below is your booking details.</span>
				</td>
			</tr>
			<tr>
				<td style="padding: 20px;" colspan="2" align="center" >
					<table style="width:100%;" cellspacing="0" cellpadding="0">
						...
						<tr style="background: rgba(255,255,255,.7)">
							<td  style="padding: 8px 20px;"><strong style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Payment Date:</strong></td>

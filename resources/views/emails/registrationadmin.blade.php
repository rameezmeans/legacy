...
<head>
	...
	<title>New User Registered notifications on {{ config('legacy.site_name') }}</title>
	<style type="text/css">
		body{
		margin: 0;
		padding: 0;
	...
	<table align="center" style=" border-collapse: collapse;width:600px; " border="0" cellpadding="0px" cellspacing="0px">
		<tbody>
			...
			<tr>
				...
				<span style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">New user registered on {{ config('legacy.site_name') }} website.<br/>Below is your account details.</span>
				</td>
			</tr>
			<tr>

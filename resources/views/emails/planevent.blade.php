		...
		<tbody>
			...
			<tr>
				<td colspan="2" style="padding: 20px;" align="center" >
					...
					<span style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Following Details has been submitted from {{ $userData['name'] }} Book an Event Form.</span>
				</td>
			</tr>
			<tr>
				<td style="padding: 20px;" colspan="2" align="center" >
					<table style="width:100%;" cellspacing="0" cellpadding="0">
						<tr style="background: rgba(255,255,255,.7); border-top:1px dashed #5680ab">
							...
							<td  style="padding: 8px 20px;color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">{{ $userData['name'] }}</td>
						</tr>
						...
						<tr style="background: rgba(255,255,255,.7)">
							<td  style="padding: 8px 20px;"><strong style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Date/Time :</strong></td>
							<td  style="padding: 8px 20px;color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">{{ $userData['datetime']}}</td>
						</tr>
					</table>
				</td>
			</tr>

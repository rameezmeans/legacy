...
<head>
	...
	<title>Legacy Partner - {{ config('legacy.site_name') }}</title>
	<style type="text/css">
		body{
		margin: 0;
		padding: 0;
		...
		<tbody>
			...
			<tr>
				<td colspan="2" style="padding: 20px;" align="center" >
					...
					<span style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Following Details has been submitted from {{ $userData['yname'] }} Contact us Form.</span>
				</td>
			</tr>
			<tr>
				<td style="padding: 20px;" colspan="2" align="center" >
					<table style="width:100%;" cellspacing="0" cellpadding="0">
						<tr style="background: rgba(255,255,255,.7); border-top:1px dashed #5680ab">
							...
							<td  style="padding: 8px 20px;color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">{{ $userData['yname'] }}</td>
						</tr>
						<tr style="background: rgba(255,255,255,.7)">
							<td  style="padding: 8px 20px;"><strong style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Company name:</strong></td>
							<td  style="padding: 8px 20px;color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">{{ $userData['cname'] }}</td>
						</tr>
						<tr style="background: rgba(255,255,255,.7)">
						...
						<tr style="background: rgba(255,255,255,.7)">
							<td  style="padding: 8px 20px;"><strong style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Message :</strong></td>

...
<head>
	...
	<title>Welcome to {{ config('legacy.site_name') }}</title>
	<style type="text/css">
		body{
		margin: 0;
		padding: 0;
...
<body>
	<table align="center" style=" border-collapse: collapse;width:600px; " border="0" cellpadding="0px" cellspacing="0px">
		<tbody>
			...
			<tr>
				<td colspan="2" style="padding: 20px;" align="center" >
					<h3 style="margin-bottom:15px; color: #707070; font-family:  Calibri , Arial; font-size:20px">Hi</h3>
				<span style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Thank you for registering to the {{ config('legacy.site_name') }} website.<br/>Below is your account details.</span>
				</td>
			</tr>
			<tr>
				<td style="padding: 20px;" colspan="2" align="center" >
                    <table style="width:100%;" cellspacing="0" cellpadding="0">
						...
						<tr style="background: rgba(255,255,255,.7)">
							<td  style="padding: 8px 20px;"><strong style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">Password:</strong></td>
							<td  style="padding: 8px 20px;color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">*********</td>
						</tr>
					</table>
				</td>
			</tr>

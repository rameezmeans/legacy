...
<head>
	...
	<title>New Booking notifications on {{ config('legacy.site_name') }}</title>
	<style type="text/css">
		body{
		margin: 0;
		padding: 0;
		...
		<tbody>
			...
			<tr>
				<td colspan="2" style="padding: 20px;" align="center" >
					...
					<span style="color: #707070;font-size: 18px; font-family:  Calibri , Arial; ">You have recevied an booking from {{ $orderData['name'] }}.<br/>The booking is as follow.</span>
				</td>
			</tr>
			<tr>

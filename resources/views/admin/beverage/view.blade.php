...
<h3><i class="fa fa-angle-right"></i>Beverage Service Detail</h3>
                ...
                <table class="table table-bordered table-striped table-condensed">
                    <tbody>
                        <tr>
                            ...
                            <td><h5>{{ $entry->beverage_name }}</h5></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <a class="btn btn-info" href="{{ route('admin::beverages.edit', $entry->id) }}">Edit</a>
                                <a class="btn btn-primary" href="{{ route('admin::beverages.index') }}">Back To List</a>
                            </td>
                        </tr>
                    </tbody>
                </table>

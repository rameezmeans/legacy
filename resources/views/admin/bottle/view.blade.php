...
<h3><i class="fa fa-angle-right"></i>Bottle Detail</h3>
            ...
            <section>
                <table class="table table-bordered table-striped table-condensed">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2">
                                <a class="btn btn-info" href="{{ route('admin::bottles.edit',  $entry->id) }}">Edit</a>
                                <a class="btn btn-primary" href="{{ route('admin::bottles.index') }}">Back To List</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
